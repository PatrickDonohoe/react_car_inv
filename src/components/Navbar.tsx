...
function Navbar() {
  ...
  return (
    <nav className="flex items-center justify-between flex-wrap bg-[#0F4C5C] p-6">
			<div className="flex item-center flex-shrink-0 text-[#E36414] mr-6">
						...
						<button className="p-3 m-5 bg-[#5F0F40] justify-center border-red-900 border-2">
							<div>
								<Link to='/' onClick={ clicked } className='flex place-items-center mt-4 lg:inline-block 
									lg:mt-0 text-[#E36414] hover:text-white mr-4'>Home
								</Link>
							</div>
						</button>
						<button className="p-3 m-5 bg-[#5F0F40] justify-center border-red-900 border-2">
